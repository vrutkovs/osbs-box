...
oc secrets new-dockercfg v2-registry-dockercfg --docker-server=${WORKSTATION_IP}:5000 --docker-username=osbs --docker-password=craycray --docker-email=test@test.com
